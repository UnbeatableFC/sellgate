  ...
  return (
    <section className="py-16 px-4 lg:px-0">
      <div className="container mx-auto text-center mb-10 relative">
        ...
        {/* Scroll Button */}
        <div className="absolute right-0 -bottom-10 md:bottom-[-30px] flex space-x-2">
          <button
            onClick={() => scroll("left")}
            disabled={!canScrollLeft}
            className={`md:p-2 p-1 rounded border ${
              canScrollLeft
                ? "bg-white text-black"
      ...
      <div
        ...
        className={`mx-auto container overflow-x-scroll flex space-x-6 relative ${
